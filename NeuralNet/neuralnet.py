...
class neural_net():
	...
	def SGD(self,training_data,epochs,mini_batch_size,eta,evaluation_data=None,monitor_evaluation_cost=False,monitor_evaluation_accuracy=False,monitor_training_cost=False,monitor_training_accuracy=False):
		...
		for j in range(epochs):
			...
			for i in range(batches-1):
				...
				self.update_mini_batch((x_tr,y_tr), eta) # check this
				
			print ("Epoch ",j," training complete")

			if monitor_training_cost:
				cost = self.total_cost(list(zip(x_train,y_train)))
...
net.SGD(train_data,51,100,0.5,evaluation_data=test_data,monitor_evaluation_accuracy=True,monitor_evaluation_cost=True,monitor_training_accuracy=True,monitor_training_cost=True)